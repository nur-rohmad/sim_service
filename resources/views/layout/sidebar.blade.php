        ...
        <nav class="sidebar-nav">
            <ul id="sidebarnav">
                ...
                <li class="sidebar-item"> <a
                        ...
                        href="/dashboard" aria-expanded="false"><i class="me-3 far fa-clock fa-fw"
                ...
                <li class="sidebar-item"> <a
                        ...
                        <i class="me-3 fas fa-wrench" aria-hidden="true"></i><span class="hide-menu">Service</span></a>
                </li>
                <li class="sidebar-item"> <a
                        class="sidebar-link waves-effect waves-dark sidebar-link {{ Request::is('barang') ? 'active' : '' ; }}"
                        href="/barang" aria-expanded="false">
                        <i class="me-3 fas fa-boxes" aria-hidden="true"></i><span class="hide-menu">Barang</span></a>
                </li>
                <li class="sidebar-item"> <a
                        class="sidebar-link waves-effect waves-dark sidebar-link {{ Request::is('report') ? 'active' : '' ; }}"
                        href="/report" aria-expanded="false">
                        <i class="me-3 fas fa-file" aria-hidden="true"></i><span class="hide-menu">Laporan</span></a>
                </li>
